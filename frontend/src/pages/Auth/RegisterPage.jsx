...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.error || error.message || 'Failed to register, please try again');
      ...
      <div className='relative w-full max-w-md px-6'>
        <div className=' bg-white/80 backdrop-blue-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
          ...
          <div className='text-center mb-10'>
            <div className='inline-flex items-center justify-center w-14 h-14 mb-4 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 text-white'>
            ...
            <div className=" space-y-2">
              ...
              <div className="relative group">
                ...
                <input type="text"
                  ...
                  className='w-full h-12 pl-12 border-2 pr-4 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10'
          ...
          <div className='mt-8 pt-6 border-t border-slate-200/60'>
            <p className='text-center text-sm text-slate-600'>Already having an account {' '}
              <Link to='/login' className='font-semibold text-emerald-600 hover:text-emerald-700 transition-colors duration-200'>Sign in</Link>
            </p>
          </div>
        </div>
        {/* subtle footer text */}
